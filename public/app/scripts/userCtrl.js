(function () {
    ...
    function userCtrl($scope, $rootScope, $state, $window, $filter, $timeout, userServices, bootstrapError) {
        ...
        $scope.add = function () {
            ...
            if (check === true) {
                $scope.incharge.employeeId = ($scope.incharge.employeeId);
                $scope.incharge.name = ($scope.incharge.name);
                $scope.incharge.Tag = ($scope.incharge.Tag);
                $scope.incharge.Designation = ($scope.incharge.Designation);
                // $scope.incharge.WhatsApp = ($scope.incharge.contact.WhatsApp);
                // $scope.incharge.mobileNo = ($scope.incharge.contact.mobileNo);
        ...
        $scope.updateModal = function (employee) {
            ...
            $scope.incharge.employeeId = ($scope.incharge.employeeId);
            $scope.incharge.name = ($scope.incharge.name);
            $scope.incharge.WhatsApp = ($scope.incharge.WhatsApp);
            $scope.incharge.Tag = ($scope.incharge.Tag);
            // $scope.incharge.WhatsApp = ($scope.incharge.contact.WhatsApp);
            // $scope.incharge.mobileNo = ($scope.incharge.contact.mobileNo);
            $scope.incharge.Designation = ($scope.incharge.Designation);
